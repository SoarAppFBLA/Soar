...
export 'athletics_model.dart';

class AthleticsWidget extends StatefulWidget {
  const AthleticsWidget({super.key});

  @override
  State<AthleticsWidget> createState() => _AthleticsWidgetState();
}

class _AthleticsWidgetState extends State<AthleticsWidget> {
  late AthleticsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AthleticsModel());
  }
              ...
              builder: (context) {
                return GestureDetector(
                  onTap: () => _model.unfocusNode.canRequestFocus
                      ? FocusScope.of(context).requestFocus(_model.unfocusNode)
                      : FocusScope.of(context).unfocus(),
                  // Child widget is a Padding containing AddAthleticsWidget
                  child: Padding(
                    padding: MediaQuery.viewInsetsOf(context),
                    // Display AddAthleticsWidget
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (context, listViewIndex) {
                            ...
                            return AlthleticsAddedWidget(
                              key: Key(
                                  'Keyfm9_${listViewIndex}_of_${listViewAthleticsRecordList.length}'),
