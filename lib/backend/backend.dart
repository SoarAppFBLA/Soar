...
import 'schema/performing_arts_record.dart';
...
import 'schema/award_record.dart';
...
export 'schema/performing_arts_record.dart';
...
export 'schema/award_record.dart';
...
/// Functions to query PerformingArtsRecords (as a Stream and as a Future).
Future<int> queryPerformingArtsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PerformingArtsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PerformingArtsRecord>> queryPerformingArtsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PerformingArtsRecord.collection,
      PerformingArtsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PerformingArtsRecord>> queryPerformingArtsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query AthleticsRecords (as a Stream and as a Future).
Future<int> queryAthleticsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<AthleticsRecord>> queryAthleticsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<AthleticsRecord>> queryAthleticsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query AwardRecords (as a Stream and as a Future).
Future<int> queryAwardRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AwardRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AwardRecord>> queryAwardRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AwardRecord.collection,
      AwardRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AwardRecord>> queryAwardRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
