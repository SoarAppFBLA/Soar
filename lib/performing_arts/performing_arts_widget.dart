...
import '/components/add_art_widget.dart';
import '/components/art_widget.dart';
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: StreamBuilder<List<PerformingArtsRecord>>(
                      stream: queryPerformingArtsRecord(
                        queryBuilder: (performingArtsRecord) =>
                            performingArtsRecord.where(
                          'uid',
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<PerformingArtsRecord>
                            listViewPerformingArtsRecordList = snapshot.data!;
                        return ListView.separated(
                          padding: EdgeInsets.zero,
                          scrollDirection: Axis.vertical,
                          itemCount: listViewPerformingArtsRecordList.length,
                          separatorBuilder: (_, __) => const SizedBox(height: 12.0),
                          itemBuilder: (context, listViewIndex) {
                            final listViewPerformingArtsRecord =
                                listViewPerformingArtsRecordList[listViewIndex];
                            return ArtWidget(
                              key: Key(
                                  'Keyh48_${listViewIndex}_of_${listViewPerformingArtsRecordList.length}'),
                              artDoc: listViewPerformingArtsRecord,
                            );
                          },
                        );
                      },
