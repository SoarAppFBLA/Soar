...
import 'add_athletics_model.dart';
export 'add_athletics_model.dart';

class AddAthleticsWidget extends StatefulWidget {
  const AddAthleticsWidget({
    super.key,
  ...
  @override
  State<AddAthleticsWidget> createState() => _AddAthleticsWidgetState();
}

class _AddAthleticsWidgetState extends State<AddAthleticsWidget> {
  late AddAthleticsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAthleticsModel());
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            FFButtonWidget(
              onPressed: () async {
                await AthleticsRecord.collection
                    .doc()
                    .set(createAthleticsRecordData(
