...
import 'add_club_org_model.dart';
export 'add_club_org_model.dart';

class AddClubOrgWidget extends StatefulWidget {
  const AddClubOrgWidget({
    super.key,
  ...
  @override
  State<AddClubOrgWidget> createState() => _AddClubOrgWidgetState();
}

class _AddClubOrgWidgetState extends State<AddClubOrgWidget> {
  late AddClubOrgModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddClubOrgModel());
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                maxLength: 15,
                validator:
                    _model.roleTextControllerValidator.asValidator(context),
              ),
              TextFormField(
              ...
              FFButtonWidget(
                onPressed: () async {
                  await ClubsRecord.collection.doc().set(createClubsRecordData(
